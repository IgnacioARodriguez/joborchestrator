...
TRANSITIONS = {
    ...
    "filling": {"prefilled", "submit_only", "ready_for_review", "needs_user_input", "failed", "cancelled"},
    "prefilled": {"submit_only", "ready_for_review", "needs_user_input", "failed", "cancelled"},
    "needs_user_input": {"ready_to_fill", "filling", "submit_only", "ready_for_review", "submitted_manually", "cancelled"},
    "submit_only": {"submitted_manually", "approved", "cancelled"},
    "ready_for_review": {"submit_only", "submitted_manually", "approved", "cancelled"},
