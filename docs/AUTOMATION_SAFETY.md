...
- Generic form and Lever can fill safe fields, upload a resume PDF and detect final submit controls in `review_before_submit`, but final submit remains a user-owned boundary.
