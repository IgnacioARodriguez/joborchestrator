...
| --- | --- | --- | --- | --- |
| Prompt registry | Active prompt versions are explicit and shared | Green | Registry points ranking to v6, materials to v3, and judge to v1 | Need a full v6 production rerank and fresh materials v3 generation proof before stored outputs match the active registry |
