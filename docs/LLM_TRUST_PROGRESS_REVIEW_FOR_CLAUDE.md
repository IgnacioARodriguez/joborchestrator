...
- Materials/ATS remain under-measured and should be the next main surface after documenting this ranking checkpoint. Current local materials work has moved to CV v14 / kit v14 plus controlled planner-renderer work with canonical employer technology preservation, an explicit ATS fit analysis payload, cautious-tone repair hardening, adaptive validation retry budgets, fail-closed validation metadata, polished parseable PDF/DOCX exports, and deterministic overcompression checks.
